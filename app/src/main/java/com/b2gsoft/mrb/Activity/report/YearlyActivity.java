...
import com.b2gsoft.mrb.Fragment.YearlyReport.YearlyExpenseFragment;
import com.b2gsoft.mrb.Fragment.YearlyReport.YearlyIncomeFragment;
...
public class YearlyActivity extends AppCompatActivity {
    ...
    private void setUpViewPager(ViewPager viewPager) {
        ...
        adapter.addFragment(new YearlyIncomeFragment());
        adapter.addFragment(new YearlyExpenseFragment());
