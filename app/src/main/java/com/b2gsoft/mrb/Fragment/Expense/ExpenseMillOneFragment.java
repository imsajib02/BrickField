...
public class ExpenseMillOneFragment extends Fragment {
    ...
    public ExpenseMillOneFragment(int i) {
        sub_id =i;
    }
    ...
    private void getExpense() {
        ...
        JsonObjectRequest request = new JsonObjectRequest(Request.Method.GET, Url.ExpenseWiseHistory+"1&expense_sub_sector_id="+sub_id+"&token=" + sharedPreferences.getSessionToken(), jsonObject, response(), GenericVollyError.errorListener(getContext(), pDialog));
